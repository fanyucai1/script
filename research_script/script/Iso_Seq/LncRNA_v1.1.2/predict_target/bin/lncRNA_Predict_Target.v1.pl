...
&USAGE unless ($q and $t and $od and $mRNA);
...
my $cmd="perl $Bin/bin/cis_target_find.pl -q $q -t $t -od $od/Cis_target\n";
$cmd .= "perl $LNCTAR -lncSeq $q -gene $mRNA -odir $od/LncTar\n";
print "$cmd\n";
system $cmd;
...
open (OUT,">$od/lncRNA_position.target") or die $!;
...
Usage:
  ...
  -mRNA	<file> Known.longest_transcript.fa
  ...
  Ex:
	...
	perl $Script -q lnc_filter_final.fa -t gene.fa -mRNA Known.longest_transcript.fa -od Lnc_target_predict
