...
divFooter<<p(u'Copyright © 2017 上海欧易生物医学科技有限公司 保留所有权利'.encode("UTF-8"))
divFooter<<p(u'地址：上海市闵行区浦江镇新骏环路138号5幢302'.encode("UTF-8"))
ulfooter=divFooter<<ul(cl="list-inline list-unstyled")
ulfooter<<li("<a href=\"http://www.oebiotech.com\" target=\"_blank\"><p class=\"ex\"> 关于我们 </p></a>")
