...
def run(target_bed,probe_bed,bam,outdir,prefix):
    ...
    cmd="java -Xmx40g -jar %s -T DepthOfCoverage --fix_misencoded_quality_scores --minBaseQuality 20 --minMappingQuality 20 -R %s -I %s -o %s -ct 50 -L %s/target.interval_list"\
